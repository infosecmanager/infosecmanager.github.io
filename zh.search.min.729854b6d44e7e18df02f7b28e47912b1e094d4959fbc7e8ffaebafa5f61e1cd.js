...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cismreview/flexsearch.min.js');loadScript('/cismreview/zh.search-data.min.b26ef3cfbf84ce348d931601b11a719ad77f97abbd92a1a1179a0be5b71b8d45.js',function(){input.required=false;search();});}
